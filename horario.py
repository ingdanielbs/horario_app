...
def horario(name):
    ...
    instructor = {
        ...
        "horario": {
            "lunes": {
                "6-7": df[df['6-7L'].notnull()][['6-7L', 'NC', 'FICHA']].rename(columns={'6-7L': 'AMB'}).to_dict('records'),
                "7-8": df[df['7-8L'].notnull()][['7-8L', 'NC', 'FICHA']].rename(columns={'7-8L': 'AMB'}).to_dict('records'),
                "8-9": df[df['8-9L'].notnull()][['8-9L', 'NC', 'FICHA']].rename(columns={'8-9L': 'AMB'}).to_dict('records'),
                "9-10": df[df['9-10L'].notnull()][['9-10L', 'NC', 'FICHA']].rename(columns={'9-10L': 'AMB'}).to_dict('records'),
                "10-11": df[df['10-11L'].notnull()][['10-11L', 'NC', 'FICHA']].rename(columns={'10-11L': 'AMB'}).to_dict('records'),
                "11-12": df[df['11-12L'].notnull()][['11-12L', 'NC', 'FICHA']].rename(columns={'11-12L': 'AMB'}).to_dict('records'),
                "12-13": df[df['12-13L'].notnull()][['12-13L', 'NC', 'FICHA']].rename(columns={'12-13L': 'AMB'}).to_dict('records'),
                "13-14": df[df['13-14L'].notnull()][['13-14L', 'NC', 'FICHA']].rename(columns={'13-14L': 'AMB'}).to_dict('records'),
                "14-15": df[df['14-15L'].notnull()][['14-15L', 'NC', 'FICHA']].rename(columns={'14-15L': 'AMB'}).to_dict('records'),
                "15-16": df[df['15-16L'].notnull()][['15-16L', 'NC', 'FICHA']].rename(columns={'15-16L': 'AMB'}).to_dict('records'),
                "16-17": df[df['16-17L'].notnull()][['16-17L', 'NC', 'FICHA']].rename(columns={'16-17L': 'AMB'}).to_dict('records'),
                "17-18": df[df['17-18L'].notnull()][['17-18L', 'NC', 'FICHA']].rename(columns={'17-18L': 'AMB'}).to_dict('records'),
                "18-19": df[df['18-19L'].notnull()][['18-19L', 'NC', 'FICHA']].rename(columns={'18-19L': 'AMB'}).to_dict('records'),
                "19-20": df[df['19-20L'].notnull()][['19-20L', 'NC', 'FICHA']].rename(columns={'19-20L': 'AMB'}).to_dict('records'),
                "20-21": df[df['20-21L'].notnull()][['20-21L', 'NC', 'FICHA']].rename(columns={'20-21L': 'AMB'}).to_dict('records'),
                "21-22": df[df['21-22L'].notnull()][['21-22L', 'NC', 'FICHA']].rename(columns={'21-22L': 'AMB'}).to_dict('records'),
            },
            "martes": {
                "6-7": df[df['6-7M'].notnull()][['6-7M', 'NC', 'FICHA']].rename(columns={'6-7M': 'AMB'}).to_dict('records'),
                "7-8": df[df['7-8M'].notnull()][['7-8M', 'NC', 'FICHA']].rename(columns={'7-8M': 'AMB'}).to_dict('records'),
                "8-9": df[df['8-9M'].notnull()][['8-9M', 'NC', 'FICHA']].rename(columns={'8-9M': 'AMB'}).to_dict('records'),
                "9-10": df[df['9-10M'].notnull()][['9-10M', 'NC', 'FICHA']].rename(columns={'9-10M': 'AMB'}).to_dict('records'),
                "10-11": df[df['10-11M'].notnull()][['10-11M', 'NC', 'FICHA']].rename(columns={'10-11M': 'AMB'}).to_dict('records'),
                "11-12": df[df['11-12M'].notnull()][['11-12M', 'NC', 'FICHA']].rename(columns={'11-12M': 'AMB'}).to_dict('records'),
                "12-13": df[df['12-13M'].notnull()][['12-13M', 'NC', 'FICHA']].rename(columns={'12-13M': 'AMB'}).to_dict('records'),
                "13-14": df[df['13-14M'].notnull()][['13-14M', 'NC', 'FICHA']].rename(columns={'13-14M': 'AMB'}).to_dict('records'),
                "14-15": df[df['14-15M'].notnull()][['14-15M', 'NC', 'FICHA']].rename(columns={'14-15M': 'AMB'}).to_dict('records'),
                "15-16": df[df['15-16M'].notnull()][['15-16M', 'NC', 'FICHA']].rename(columns={'15-16M': 'AMB'}).to_dict('records'),
                "16-17": df[df['16-17M'].notnull()][['16-17M', 'NC', 'FICHA']].rename(columns={'16-17M': 'AMB'}).to_dict('records'),
                "17-18": df[df['17-18M'].notnull()][['17-18M', 'NC', 'FICHA']].rename(columns={'17-18M': 'AMB'}).to_dict('records'),
                "18-19": df[df['18-19M'].notnull()][['18-19M', 'NC', 'FICHA']].rename(columns={'18-19M': 'AMB'}).to_dict('records'),
                "19-20": df[df['19-20M'].notnull()][['19-20M', 'NC', 'FICHA']].rename(columns={'19-20M': 'AMB'}).to_dict('records'),
                "20-21": df[df['20-21M'].notnull()][['20-21M', 'NC', 'FICHA']].rename(columns={'20-21M': 'AMB'}).to_dict('records'),
                "21-22": df[df['21-22M'].notnull()][['21-22M', 'NC', 'FICHA']].rename(columns={'21-22M': 'AMB'}).to_dict('records')
            },
            "miercoles": {
                "6-7": df[df['6-7MI'].notnull()][['6-7MI', 'NC', 'FICHA']].rename(columns={'6-7MI': 'AMB'}).to_dict('records'),
                "7-8": df[df['7-8MI'].notnull()][['7-8MI', 'NC', 'FICHA']].rename(columns={'7-8MI': 'AMB'}).to_dict('records'),
                "8-9": df[df['8-9MI'].notnull()][['8-9MI', 'NC', 'FICHA']].rename(columns={'8-9MI': 'AMB'}).to_dict('records'),
                "9-10": df[df['9-10MI'].notnull()][['9-10MI', 'NC', 'FICHA']].rename(columns={'9-10MI': 'AMB'}).to_dict('records'),
                "10-11": df[df['10-11MI'].notnull()][['10-11MI', 'NC', 'FICHA']].rename(columns={'10-11MI': 'AMB'}).to_dict('records'),
                "11-12": df[df['11-12MI'].notnull()][['11-12MI', 'NC', 'FICHA']].rename(columns={'11-12MI': 'AMB'}).to_dict('records'),
                "12-13": df[df['12-13MI'].notnull()][['12-13MI', 'NC', 'FICHA']].rename(columns={'12-13MI': 'AMB'}).to_dict('records'),
                "13-14": df[df['13-14MI'].notnull()][['13-14MI', 'NC', 'FICHA']].rename(columns={'13-14MI': 'AMB'}).to_dict('records'),
                "14-15": df[df['14-15MI'].notnull()][['14-15MI', 'NC', 'FICHA']].rename(columns={'14-15MI': 'AMB'}).to_dict('records'),
                "15-16": df[df['15-16MI'].notnull()][['15-16MI', 'NC', 'FICHA']].rename(columns={'15-16MI': 'AMB'}).to_dict('records'),
                "16-17": df[df['16-17MI'].notnull()][['16-17MI', 'NC', 'FICHA']].rename(columns={'16-17MI': 'AMB'}).to_dict('records'),
                "17-18": df[df['17-18MI'].notnull()][['17-18MI', 'NC', 'FICHA']].rename(columns={'17-18MI': 'AMB'}).to_dict('records'),
                "18-19": df[df['18-19MI'].notnull()][['18-19MI', 'NC', 'FICHA']].rename(columns={'18-19MI': 'AMB'}).to_dict('records'),
                "19-20": df[df['19-20MI'].notnull()][['19-20MI', 'NC', 'FICHA']].rename(columns={'19-20MI': 'AMB'}).to_dict('records'),
                "20-21": df[df['20-21MI'].notnull()][['20-21MI', 'NC', 'FICHA']].rename(columns={'20-21MI': 'AMB'}).to_dict('records'),
                "21-22": df[df['21-22MI'].notnull()][['21-22MI', 'NC', 'FICHA']].rename(columns={'21-22MI': 'AMB'}).to_dict('records')
            },
            "jueves": {
                "6-7": df[df['6-7J'].notnull()][['6-7J', 'NC', 'FICHA']].rename(columns={'6-7J': 'AMB'}).to_dict('records'),
                "7-8": df[df['7-8J'].notnull()][['7-8J', 'NC', 'FICHA']].rename(columns={'7-8J': 'AMB'}).to_dict('records'),
                "8-9": df[df['8-9J'].notnull()][['8-9J', 'NC', 'FICHA']].rename(columns={'8-9J': 'AMB'}).to_dict('records'),
                "9-10": df[df['9-10J'].notnull()][['9-10J', 'NC', 'FICHA']].rename(columns={'9-10J': 'AMB'}).to_dict('records'),
                "10-11": df[df['10-11J'].notnull()][['10-11J', 'NC', 'FICHA']].rename(columns={'10-11J': 'AMB'}).to_dict('records'),
                "11-12": df[df['11-12J'].notnull()][['11-12J', 'NC', 'FICHA']].rename(columns={'11-12J': 'AMB'}).to_dict('records'),
                "12-13": df[df['12-13J'].notnull()][['12-13J', 'NC', 'FICHA']].rename(columns={'12-13J': 'AMB'}).to_dict('records'),
                "13-14": df[df['13-14J'].notnull()][['13-14J', 'NC', 'FICHA']].rename(columns={'13-14J': 'AMB'}).to_dict('records'),
                "14-15": df[df['14-15J'].notnull()][['14-15J', 'NC', 'FICHA']].rename(columns={'14-15J': 'AMB'}).to_dict('records'),
                "15-16": df[df['15-16J'].notnull()][['15-16J', 'NC', 'FICHA']].rename(columns={'15-16J': 'AMB'}).to_dict('records'),
                "16-17": df[df['16-17J'].notnull()][['16-17J', 'NC', 'FICHA']].rename(columns={'16-17J': 'AMB'}).to_dict('records'),
                "17-18": df[df['17-18J'].notnull()][['17-18J', 'NC', 'FICHA']].rename(columns={'17-18J': 'AMB'}).to_dict('records'),
                "18-19": df[df['18-19J'].notnull()][['18-19J', 'NC', 'FICHA']].rename(columns={'18-19J': 'AMB'}).to_dict('records'),
                "19-20": df[df['19-20J'].notnull()][['19-20J', 'NC', 'FICHA']].rename(columns={'19-20J': 'AMB'}).to_dict('records'),
                "20-21": df[df['20-21J'].notnull()][['20-21J', 'NC', 'FICHA']].rename(columns={'20-21J': 'AMB'}).to_dict('records'),
                "21-22": df[df['21-22J'].notnull()][['21-22J', 'NC', 'FICHA']].rename(columns={'21-22J': 'AMB'}).to_dict('records')
            },
            "viernes": {
                "6-7": df[df['6-7V'].notnull()][['6-7V', 'NC', 'FICHA']].rename(columns={'6-7V': 'AMB'}).to_dict('records'),
                "7-8": df[df['7-8V'].notnull()][['7-8V', 'NC', 'FICHA']].rename(columns={'7-8V': 'AMB'}).to_dict('records'),
                "8-9": df[df['8-9V'].notnull()][['8-9V', 'NC', 'FICHA']].rename(columns={'8-9V': 'AMB'}).to_dict('records'),
                "9-10": df[df['9-10V'].notnull()][['9-10V', 'NC', 'FICHA']].rename(columns={'9-10V': 'AMB'}).to_dict('records'),
                "10-11": df[df['10-11V'].notnull()][['10-11V', 'NC', 'FICHA']].rename(columns={'10-11V': 'AMB'}).to_dict('records'),
                "11-12": df[df['11-12V'].notnull()][['11-12V', 'NC', 'FICHA']].rename(columns={'11-12V': 'AMB'}).to_dict('records'),
                "12-13": df[df['12-13V'].notnull()][['12-13V', 'NC', 'FICHA']].rename(columns={'12-13V': 'AMB'}).to_dict('records'),
                "13-14": df[df['13-14V'].notnull()][['13-14V', 'NC', 'FICHA']].rename(columns={'13-14V': 'AMB'}).to_dict('records'),
                "14-15": df[df['14-15V'].notnull()][['14-15V', 'NC', 'FICHA']].rename(columns={'14-15V': 'AMB'}).to_dict('records'),
                "15-16": df[df['15-16V'].notnull()][['15-16V', 'NC', 'FICHA']].rename(columns={'15-16V': 'AMB'}).to_dict('records'),
                "16-17": df[df['16-17V'].notnull()][['16-17V', 'NC', 'FICHA']].rename(columns={'16-17V': 'AMB'}).to_dict('records'),
                "17-18": df[df['17-18V'].notnull()][['17-18V', 'NC', 'FICHA']].rename(columns={'17-18V': 'AMB'}).to_dict('records'),
                "18-19": df[df['18-19V'].notnull()][['18-19V', 'NC', 'FICHA']].rename(columns={'18-19V': 'AMB'}).to_dict('records'),
                "19-20": df[df['19-20V'].notnull()][['19-20V', 'NC', 'FICHA']].rename(columns={'19-20V': 'AMB'}).to_dict('records'),
                "20-21": df[df['20-21V'].notnull()][['20-21V', 'NC', 'FICHA']].rename(columns={'20-21V': 'AMB'}).to_dict('records'),
                "21-22": df[df['21-22V'].notnull()][['21-22V', 'NC', 'FICHA']].rename(columns={'21-22V': 'AMB'}).to_dict('records')
            },
            "sabado": {
                "6-8": df[df['6-8S'].notnull()][['6-8S', 'NC', 'FICHA']].rename(columns={'6-8S': 'AMB'}).to_dict('records'),
                "8-9": df[df['8-9S'].notnull()][['8-9S', 'NC', 'FICHA']].rename(columns={'8-9S': 'AMB'}).to_dict('records'),
                "9-10": df[df['9-10S'].notnull()][['9-10S', 'NC', 'FICHA']].rename(columns={'9-10S': 'AMB'}).to_dict('records'),
                "10-11": df[df['10-11S'].notnull()][['10-11S', 'NC', 'FICHA']].rename(columns={'10-11S': 'AMB'}).to_dict('records'),
                "11-12": df[df['11-12S'].notnull()][['11-12S', 'NC', 'FICHA']].rename(columns={'11-12S': 'AMB'}).to_dict('records'),
                "12-13": df[df['12-13S'].notnull()][['12-13S', 'NC', 'FICHA']].rename(columns={'12-13S': 'AMB'}).to_dict('records'),
                "13-14": df[df['13-14S'].notnull()][['13-14S', 'NC', 'FICHA']].rename(columns={'13-14S': 'AMB'}).to_dict('records'),
            },
